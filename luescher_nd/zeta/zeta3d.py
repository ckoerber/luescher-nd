...
@dataclass(frozen=True)
class ContinuumZeta3D:
    """Three dimensional Zeta function for continuum finite volume.
    """
    ...
    def Lambda(self) -> float:
        """Returns $Lambda = 2 \\pi N / L$.
        """
        return 2 * np.pi * self.N / self.L
    ...
    def _get_n2(self) -> np.ndarray:
        ...
        The shape is [n1d**3, 3] where the second components access nx, ny, nz.
        """
        n2_disp1d = np.arange(0, self.N) ** 2
    ...
    def __post_init__(self):
        ...
        object.__setattr__(self, "_normalization", -4 * np.pi * self.N)
