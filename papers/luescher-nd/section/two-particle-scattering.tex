...
Projecting onto the $D$ dimensional set of partial waves labelled by $\l$, the $T$ matrix may be re-expressed in terms of phase shifts \todo{and inelasticities?},
...
\begin{align}
    ...
    \, ,
\end{align}
where $R_{l D}$ is an arbitrary length scale and $a_{l D}$, $r_{l D}$ and subsequent higher-order coefficients describe the properties of the two-particle interaction.
