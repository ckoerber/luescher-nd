...
In \Ref{He:2019ipt} the lattice implementation was smeared to reduce errors due to discretization, however a direct comparison of other methods with theirs was not possible for us since we were not able to identify the discretization parameters for the phase shifts presented in their Fig. 7.
