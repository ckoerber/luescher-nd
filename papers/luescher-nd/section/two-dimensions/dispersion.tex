...
In \Appref{counterterm/dispersion}\todo{I do not find it in the appendix} we derive this dispersion L\"uscher formula for 2D and only state the result here.
