...
Given a contact interaction with coefficient appropriately tuned to the continuum scattering length $\tilde a_{2}$ and accounts for the discretization $\epsilon=N/L$ (see \Appref{counterterm/dispersion}),
\begin{equation}
