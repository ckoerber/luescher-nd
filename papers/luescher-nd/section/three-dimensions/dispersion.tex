...
We now want to find an equivalent expression to the FV zeta functions in presence of a discretization scheme $\dispersion$.
...
\begin{equation}\label{eq:dispersion-zeta-contact}
	...
	\, ,
	\qquad
	\mathcal{L}_3^{(n_s)}=15.348248444887464047104634
	=
	? \times
