...
\end{equation}
where the $\spherical$ superscript reminds us that we cut off our sum and integral in a spherical way, based on the magnitude of $n<N/2$.  The expression proportional to the heavyside function in~\eqref{spherical cutoff S} exactly compensates the term proportional to the heavyside function on the LHS of~\eqref{general luscher}.   By performing the principal value integrals and taking the limit $N\to \infty$, we recover the usual \Luscher zeta functions,
