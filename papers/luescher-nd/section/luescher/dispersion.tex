...
As mentioned at the end of \Secref{continuum}, one approach is to require the lowest energy state, when put through $S^{\spherical}$, match the desired scattering amplitude, an approach taken in, for example, \Refs{Endres:2011er,Lee:2007ae,Endres:2012cw}.
