...
\todo{We've eliminated all the discussion of the 'cartesian' method, so a variety of things here don't make sense.  In particular showing the dispersion ct --> cartesian ct when nstep goes to infinity, which is a good idiot check.  SO, here define cartesian guy, get the counterterm, mention it's not the spherical thing because the corners of the sum, and then do the dispersion guy.}
