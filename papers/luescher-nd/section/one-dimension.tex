...
%\includegraphics[width=.65\textwidth]{figure/1d.pdf}
    \caption{
		...
		\textit{(top)} 
			...
			The eigenvalues are obtained for a contact interaction which fulfills eq.~\eqref{tuning-1d} fixed to $\tilde a_{20}/L=1/10$ (closed symbols) and $\tilde a_{20}/L=0$ (open symbols).
