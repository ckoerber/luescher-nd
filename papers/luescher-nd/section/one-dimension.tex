...
\end{equation}
consistent with those found in \cite{}\todo{CITE}.
...
However, we also show the scattering data determined through $S^{\dispersion}_1(x^\dispersion)$ (black points), and these all lie on a flat line, as expected.
