...
The colored dashed lines in \Figref{luescher1d} correspond to the functions given in this table.  In the limit $N\goesto\infty$ all states are included in the Brillouin zone so all terms vanish and one recovers the flat, momentum-independent behavior.
