\subsection{Scattering on the lattice, \Luscher's Formula}\label{sec:spherical}
...
In the following content we concentrate on $S$-waves as this is this is the only partial wave contributing to the later unitarity analysis for given contact interactions.
