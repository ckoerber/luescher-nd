...
The interaction strength $C(\Lambda)$ is tuned such that the ground state energy $E_0$ matches the first zero of the spherical zeta function $S^{\spherical}_3$ (eq.~\eqref{spherical quantization} and see also \figref{tuning}) and dispersion zeta function (eq.~\eqref{dispersion quantization}).
