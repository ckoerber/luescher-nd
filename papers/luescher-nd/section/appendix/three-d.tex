...
\end{equation}
where now the coefficient $\counterterm_2^\dispersion$ carries a $n_s$ dependence.\todo{I would like to remove this last sentence, since nowhere do we consider calculating this coefficient for $n_s\ne \infty$.}
