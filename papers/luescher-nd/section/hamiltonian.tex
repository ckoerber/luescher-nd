...
The $\dispersion$ symbol indicates that quantities depend on the box volume $L$, the lattice spacing $\epsilon$ and the explicit implementation of discretization effects like derivatives.
