...
\begin{equation}\label{eq:cartesian integral}
	\left(\frac{2\mu}{(2\pi)^2 L}\right)\inverse I^{\cartesian N}_0(x=0) = \int_{-N/2}^{+N/2} \mathrm{d}n_x\ \mathrm{d}n_y\ \mathrm{d}n_z \frac{1}{n^2}
\end{equation}
...
\begin{align}
	\left(\frac{2\mu}{(2\pi)^2 L}\right)\inverse I^{\cartesian N}_0 = J^{\cartesian N}_0(0) - J^{\cartesian N}_0(\infty)
...
\begin{align}
    \left(\frac{2\mu}{(2\pi)^2 L}\right)\inverse
    I^{\cartesian N}_0
    &=
...
\begin{equation}
    \counterterm^\cartesian_3 \left(\frac{N}{2}\right) = \lim_{N\goesto\infty}\left(\frac{2\mu}{(2\pi)^2 L}\right)\inverse I^{\cartesian N}_0(x=0) = 15.34824844488746404710\ \left(\frac{N}{2}\right)
\end{equation}
