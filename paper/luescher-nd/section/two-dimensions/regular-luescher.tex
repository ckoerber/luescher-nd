...
\end{equation}
which is consistent with~\cite{Zhu:2019dho} once the subtraction of the logarithm and the difference in definition of our zeta functions are taken into account. For higher partial waves we refer the reader to Ref.~\cite{Fiebig:1994qi}.
