The two-dimensional case was originally considered in~\cite{Fiebig:1994qi}, and subsequently worked out in detail for the s-wave case in~\cite{Beane:2010ny}.
To begin, we assume a contact interaction and write the effective range expansion \eqref{ere} in terms of a \emph{reduced} scattering length,
...
\end{equation}
This form was originally derived in \Ref{Beane:2010ny}, and is also consistent with \Ref{Zhu:2019dho} once the subtraction of the logarithm and the difference in the definition of our zeta functions are taken into account. For higher partial waves we refer the reader to Ref.~\cite{Fiebig:1994qi}.
