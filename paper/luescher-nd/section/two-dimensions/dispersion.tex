...
\end{align}
where the lattice spacing $\epsilon=N/L$ and $G$ is Catalan's constant.  In \Appref{3D dispersion} we derive explicitly the counterterm $\mathcal{L}^\dispersion_{2}$.
