...
\end{align}
where $G$ is Catalan's constant. %\todo{Hmmm. . . this counterterm has an $N$ dependence, right?}
...
\begin{equation}
    ...
    + \ldots
\end{equation}
The coefficients $\alpha_i(N)$ have an implicit dependence on $N$ since the sums are restricted outside of the Brillouin zone.  Further, in 2-D the sums involved in $\alpha_i$ converge sufficiently fast and there exist various techniques for evaluating these sums (see Appendix A of \Ref{Fiebig:1994qi}).
