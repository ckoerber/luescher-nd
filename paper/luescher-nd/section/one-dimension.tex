...
Since the sum in the quantization condition \eqref{general luscher}or the one-loop finite-volume sum \eqref{I0 FV} with $D=1$ is convergent we simply have %, the counterterm $\counterterm_{D=1}^\spherical=0$ and we obtain
