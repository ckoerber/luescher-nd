...
This non-perturbative renormalization allows us to extract regularization independent observables (see also \Refs{Seki:2005ns, Epelbaum:2018zli}).
...
We now want to find an equivalent expression to the finite-volume zeta functions in the presence of a discretization scheme.
