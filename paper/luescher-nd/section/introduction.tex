...
In this work, we focus on the \Luscher finite-volume formalism as its extension presented in this work allows us to exactly trace and cancel effects caused by finite discretizations.
